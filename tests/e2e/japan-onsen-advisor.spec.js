...
const SVC_URL = "https://appadaycreator.com/japan-onsen-advisor/";
const SVC_NAME = "温泉・旅館おすすめ診断";

test.describe("温泉・旅館おすすめ診断 - E2Eテスト", () => {
  ...
  test("ページ基本: タイトル・h1・canonical", async ({ page }) => {
    ...
    expect(canonical).toContain("japan-onsen-advisor");
